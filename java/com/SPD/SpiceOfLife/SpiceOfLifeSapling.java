...
public class SpiceOfLifeSapling extends BlockSapling{
    ...
    public static final String[] saplings = new String[] {"Cinnamon"};
    private static final IIcon[] iconLength = new IIcon[saplings.length];


    protected SpiceOfLifeSapling()
    {
        float f = 0.4F;
...
//IsSameSapling
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
            iconLength[i] = p_149651_1_.registerIcon(this.getUnlocalizedName() + "_" + saplings[i]);
        }
    }
